...
export const AfterBattle = async (battleInfo) => {
    ...
    try {
        ...
        console.error("Error reporting battle result:", error.response?.data || error.message);
...
export const getBattleResults = async () => {
    try {
        ...
        console.error("Error fetching battle results:", error.response?.data || error.message);
        return [];
    }
    // You will receive
