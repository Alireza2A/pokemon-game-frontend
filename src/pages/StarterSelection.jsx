        ...
        <div className="min-h-screen bg-gradient-to-b from-blue-500 to-indigo-600 py-10 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="text-center text-white mb-12">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6">Welcome to Your Pokémon Journey!</h1>
                    <p className="text-xl md:text-2xl">Choose your first Pokémon companion to begin your adventure.</p>
                </div>
                ...
                <div className="bg-white/90 rounded-xl p-6 mb-12 flex flex-col md:flex-row items-center shadow-xl">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800 mb-2">Professor Oak</h2>
                        <p className="text-gray-600">
                            "Welcome to the world of Pokémon! I'm Professor Oak, and I'm here to guide you on your
                            journey. Before you set off, you'll need to choose your first Pokémon partner. This choice
                            is important, as your starter will be your loyal companion through many adventures ahead.
                            Choose wisely!"
                        </p>
                    </div>
                </div>
                ...
                {showSuccess && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
                        <div className="bg-white rounded-xl p-8 max-w-md text-center shadow-2xl animate-fade-in">
                            ...
                            <h2 className="text-2xl font-bold text-gray-800 mb-2">Great Choice!</h2>
                            <p className="text-gray-600 mb-6">
                                {selectedPokemon?.name.charAt(0).toUpperCase() + selectedPokemon?.name.slice(1)} is now
                                your partner! Your adventure begins now.
                            </p>
                            <div className="w-12 h-12 mx-auto animate-bounce">
                                <svg
                                    ...
                                    xmlns="http://www.w3.org/2000/svg"
                                >
                                    <circle cx="12" cy="12" r="10" fill="white" stroke="#E53E3E" strokeWidth="2" />
                                    <path d="M2 12h20" stroke="#E53E3E" strokeWidth="2" />
                                    <circle cx="12" cy="12" r="3" fill="white" stroke="#E53E3E" strokeWidth="2" />
                                </svg>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {starters.map((pokemon) => {
                        ...
                        const gradientColors = typeColorMap[primaryType] || "from-gray-400 to-gray-500";

                        return (
                            <div
                                key={pokemon.id}
                                className={`relative ${
                                    selectedPokemon && selectedPokemon.id !== pokemon.id ? "opacity-50" : ""
                                }`}
                            >
                                <div
                  ...
                  `}
                          ...
                          ${
                              selectedPokemon && selectedPokemon.id === pokemon.id && animatingSelect
                                  ? "animate-bounce"
                                  : ""
                          }
                        `}
                        ...
                        ${selectedPokemon ? "opacity-50 cursor-not-allowed" : "hover:-translate-y-1"}
                      `}
